...
// middle and outer vertices and other special terms, you shall read
...
void WidgetNetdraw::FillAllVertices()
{
  // Prepare
  ...
  inner_vxs_ = wdg_helpers::GetPolyVertices(
  ...
  middle_vxs_ = wdg_helpers::GetPolyVertices(
  ...
  outer_vxs_ = wdg_helpers::GetPolyVertices(
